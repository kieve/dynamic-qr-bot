...
scp "%DEPLOY_DIR%run_qr.sh" "%DEPLOY_DIR%start_qr.sh" "%DEPLOY_DIR%stop_qr.sh" "%DEPLOY_DIR%restart_qr.sh" "%DEPLOY_DIR%qr-bot.service" "%DEPLOY_DIR%..\src\main\resources\application-prod.yaml" %REMOTE%:~/
